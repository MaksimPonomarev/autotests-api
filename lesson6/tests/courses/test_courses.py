...
from lesson6.clients.courses.courses_client import CoursesClient
from lesson6.clients.courses.courses_schema import UpdateCourseRequestSchema, UpdateCourseResponseSchema, \
...
from lesson6.tools.assertions.courses import assert_update_course_response, assert_get_courses_response, \
...
class TestCourses:
    ...
    def test_create_course(self, courses_client: CoursesClient, function_file: FileFixture, function_user: UserFixture):
        ...
        assert_create_course_response(create_course_request= request, create_course_response=response_data)
