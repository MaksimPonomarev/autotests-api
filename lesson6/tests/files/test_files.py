...
from lesson6.clients.errors_schema import ValidationErrorResponseSchema, InternalErrorResponseSchema
from lesson6.clients.files.files_client import FilesClient
from lesson6.clients.files.files_schema import CreateFileRequestSchema, CreateFileResponseSchema, GetFileResponseSchema
from lesson6.fixtures.files import FileFixture
from lesson6.tools.assertions.base import assert_status_code
from lesson6.tools.assertions.files import assert_create_file_response, assert_get_file_response, \
...
class TestFiles:
    ...
    def test_create_file_with_empty_filename(self, files_client: FilesClient):
        request = CreateFileRequestSchema(
            filename="",
            upload_file=r"C:\Users\mr\PycharmProjects\autotests-api\testdata\files\image.png"
        )
        response = files_client.create_file_api(request)
