...
from lesson6.clients.errors_schema import ValidationErrorResponseSchema, ValidationErrorSchema, \
    InternalErrorResponseSchema
from lesson6.clients.files.files_schema import CreateFileResponseSchema, CreateFileRequestSchema
from lesson6.tools.assertions.base import assert_equal
from lesson6.clients.files.files_schema import CreateFileResponseSchema, CreateFileRequestSchema, FileSchema, \
    GetFileResponseSchema
from lesson6.tools.assertions.base import assert_equal
from lesson6.tools.assertions.errors import assert_validation_error_response, assert_internal_error_response
...
def assert_create_file_response(request: CreateFileRequestSchema, response: CreateFileResponseSchema):
    ...
    expected_url = f"{settings.http_client.client_url}{request.directory}/{request.filename}"
...
def assert_get_file_with_incorrect_file_id_response(actual: ValidationErrorResponseSchema):
    """
    Функция для проверки ошибки, если использовать неправильный file_id для првоерки что файл есть на сервере, соответствует ожидаемой валидационной ошибке.
    :param actual:
    :return:
    """
    expected = ValidationErrorResponseSchema(
