from lesson6.clients.authentication.authentication_schema import LoginResponseSchema
from lesson6.tools.assertions.base import assert_equal, assert_is_true
